...
class ContextSelector:
    ...
    def select(self, indexed_files: Dict[str, str], task: str, max_files: int = 20) -> List[SelectedFile]:
        """
        ...
        logger.info(f"Selected {len(selected)} files within {self.token_budget} token budget")
        return selected
