...
class TestSecurity(unittest.TestCase):
    ...
    def test_forbidden_commands(self):
        ...
        self.assertFalse(is_command_allowed("rm -rf / && echo 'oops'")) # Chaining blocked
        self.assertFalse(is_command_allowed("python script.py | grep foo")) # Pipe blocked
    ...
    def test_secret_detection_aws(self):
        ...
        self.assertFalse("AKIA" in secrets[0].redacted_value) # Should ensure IA is masked
