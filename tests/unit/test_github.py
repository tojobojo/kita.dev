...
class TestGitHubIntegration(unittest.TestCase):
    ...
    def test_handler_flow_success(
        ...
        mock_create_pr.return_value = PRResult(
            success=True, pr_number=42, pr_url="https://github.com/user/repo/pull/42"
        )
    ...
    def test_handler_invalid_command_reply(self, mock_post_comment, mock_auth):
        ...
        mock_post_comment.assert_called_with(
            2, "Command not recognized. Try '@kita help'.", "user/repo"
        )
