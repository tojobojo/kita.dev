...
class TestReleaseFlow(unittest.TestCase):
    ...
    def test_gate_pass_healthy(self):
        ...
        for _ in range(100): collector.record_start()
        for _ in range(70): collector.record_success()
        for _ in range(20): collector.record_stop("Test")
        for _ in range(50): collector.record_retry()
    ...
    def test_gate_fail_low_completion(self):
        ...
        for _ in range(100): collector.record_start()
        for _ in range(20): collector.record_success()
    ...
    def test_gate_fail_reckless_stops(self):
        ...
        for _ in range(100): collector.record_start()
        for _ in range(100): collector.record_success()
    ...
    def test_gate_fail_high_retries(self):
        ...
        for _ in range(10): collector.record_start()
        for _ in range(200): collector.record_retry()
